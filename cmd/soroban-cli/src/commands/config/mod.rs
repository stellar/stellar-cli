...
pub struct Args {
    ...
    /// Account that signs the final transaction. Alias `source`
    ///
    /// SC36BWNUOCZA...  a secret key
    ///
    /// alice            an identity
    ///
    /// "kite urban .."  a seed phrase
    ///
    /// If not provided the default is the seed phrase generated by  
    /// `identity generate --default-seed`
    ///
    /// Examples:
    ///
    ///     --source alice
    ...
    ///     --source "kite urban.."
    ///
    ///     --source SC36BWNUOCZAO7DMEJNNKFV6BOTPJP7IG5PSHLUOLT6DZFRU3D3XGIXW
