...
exports.CallToolResultSchema = exports.ResultSchema.extend({
    content: zod_1.z.array(zod_1.z.union([exports.TextContentSchema, exports.ImageContentSchema, exports.EmbeddedResourceSchema])),
...
exports.SamplingMessageSchema = zod_1.z
    .object({
    role: zod_1.z.enum(["user", "assistant"]),
    content: zod_1.z.union([exports.TextContentSchema, exports.ImageContentSchema]),
})
    .passthrough();
/**
